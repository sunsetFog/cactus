<template>
<uni-shadow-root class="vant222-nav-bar-index"><view v-if="fixed && placeholder" :style="'height: '+(height)+'px;'"></view>
...
global['__wxRoute'] = 'vant222/nav-bar/index'
...
export default global['__wxComponents']['vant222/nav-bar/index']
</script>
