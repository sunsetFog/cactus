<template>
<uni-shadow-root class="vant222-tree-select-index"><view class="van-tree-select" :style="'height: '+(utils.addUnit(height))">
...
global['__wxRoute'] = 'vant222/tree-select/index'
...
export default global['__wxComponents']['vant222/tree-select/index']
</script>
