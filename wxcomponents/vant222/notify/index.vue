<template>
<uni-shadow-root class="vant222-notify-index"><van-transition name="slide-down" :show="show" custom-class="van-notify__container" :custom-style="computed.rootStyle({ zIndex, top })" @click.native="onTap">
...
global['__wxRoute'] = 'vant222/notify/index'
...
export default global['__wxComponents']['vant222/notify/index']
</script>
