<template>
<uni-shadow-root class="vant222-index-bar-index"><view class="van-index-bar">
  <slot></slot>
...
global['__wxRoute'] = 'vant222/index-bar/index'
...
export default global['__wxComponents']['vant222/index-bar/index']
</script>
