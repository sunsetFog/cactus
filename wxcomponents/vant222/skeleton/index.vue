<template>
<uni-shadow-root class="vant222-skeleton-index"><view v-if="loading" :class="'custom-class '+(utils.bem('skeleton', [{animate}]))">
...
global['__wxRoute'] = 'vant222/skeleton/index'
...
export default global['__wxComponents']['vant222/skeleton/index']
</script>
