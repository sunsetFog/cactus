<template>
<uni-shadow-root class="vant222-sticky-index"><view class="custom-class van-sticky" :style="computed.containerStyle({ fixed, height, zIndex })">
...
global['__wxRoute'] = 'vant222/sticky/index'
...
export default global['__wxComponents']['vant222/sticky/index']
</script>
