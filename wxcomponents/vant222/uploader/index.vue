<template>
<uni-shadow-root class="vant222-uploader-index"><view class="van-uploader">
...
global['__wxRoute'] = 'vant222/uploader/index'
...
export default global['__wxComponents']['vant222/uploader/index']
</script>
