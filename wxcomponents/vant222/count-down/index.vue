<template>
<uni-shadow-root class="vant222-count-down-index"><view class="van-count-down">
...
global['__wxRoute'] = 'vant222/count-down/index'
...
export default global['__wxComponents']['vant222/count-down/index']
</script>
