<template>
<uni-shadow-root class="vant222-grid-item-index"><view :class="'custom-class '+(utils.bem('grid-item', { square }))" :style="computed.wrapperStyle({ square, gutter, columnNum, index })" @click="onClick">
...
global['__wxRoute'] = 'vant222/grid-item/index'
...
export default global['__wxComponents']['vant222/grid-item/index']
</script>
