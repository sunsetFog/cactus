<template>
<uni-shadow-root class="vant222-search-index"><view :class="(utils.bem('search', { withaction: showAction || useActionSlot }))+' custom-class'" :style="'background: '+(background)">
...
global['__wxRoute'] = 'vant222/search/index'
...
export default global['__wxComponents']['vant222/search/index']
</script>
