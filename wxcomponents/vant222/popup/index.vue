<template>
<uni-shadow-root class="vant222-popup-index"><van-overlay v-if="overlay" :show="show" :z-index="zIndex" :custom-style="overlayStyle" :duration="duration" @click="onClickOverlay" :lock-scroll="lockScroll"></van-overlay>
...
global['__wxRoute'] = 'vant222/popup/index'
...
export default global['__wxComponents']['vant222/popup/index']
</script>
