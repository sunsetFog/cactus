<template>
<uni-shadow-root class="vant222-empty-index"><view class="custom-class van-empty">
...
global['__wxRoute'] = 'vant222/empty/index'
...
export default global['__wxComponents']['vant222/empty/index']
</script>
