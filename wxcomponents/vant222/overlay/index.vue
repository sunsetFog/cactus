<template>
<uni-shadow-root class="vant222-overlay-index"><van-transition v-if="lockScroll" :show="show" custom-class="van-overlay" :custom-style="'z-index: '+(zIndex)+'; '+(customStyle)" :duration="duration" @click.native="onClick" @touchmove.native.stop.prevent="noop">
  <slot></slot>
</van-transition>
...
global['__wxRoute'] = 'vant222/overlay/index'
...
export default global['__wxComponents']['vant222/overlay/index']
</script>
