<template>
<uni-shadow-root class="vant222-rate-index"><view :class="(utils.bem('rate'))+' custom-class'" @touchmove="onTouchMove">
...
global['__wxRoute'] = 'vant222/rate/index'
...
export default global['__wxComponents']['vant222/rate/index']
</script>
