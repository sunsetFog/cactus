<template>
<uni-shadow-root class="vant222-card-index"><view class="custom-class van-card">
...
global['__wxRoute'] = 'vant222/card/index'
...
export default global['__wxComponents']['vant222/card/index']
</script>
