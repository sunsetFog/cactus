<template>
<uni-shadow-root class="vant222-divider-index"><view :class="'custom-class '+(utils.bem('divider', [{ dashed, hairline }, contentPosition]))" :style="computed.rootStyle({ borderColor, textColor, fontSize, customStyle })">
  <slot></slot>
...
global['__wxRoute'] = 'vant222/divider/index'
...
export default global['__wxComponents']['vant222/divider/index']
</script>
