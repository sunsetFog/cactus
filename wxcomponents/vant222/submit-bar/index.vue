<template>
<uni-shadow-root class="vant222-submit-bar-index"><view class="van-submit-bar custom-class">
  <slot name="top"></slot>
...
global['__wxRoute'] = 'vant222/submit-bar/index'
...
export default global['__wxComponents']['vant222/submit-bar/index']
</script>
