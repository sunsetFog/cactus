<template>
<uni-shadow-root class="vant222-radio-index"><view :class="(utils.bem('radio', [direction]))+' custom-class'">
...
global['__wxRoute'] = 'vant222/radio/index'
...
export default global['__wxComponents']['vant222/radio/index']
</script>
