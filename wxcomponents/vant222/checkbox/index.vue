<template>
<uni-shadow-root class="vant222-checkbox-index"><view :class="(utils.bem('checkbox', [{ horizontal: direction === 'horizontal' }]))+' custom-class'">
...
global['__wxRoute'] = 'vant222/checkbox/index'
...
export default global['__wxComponents']['vant222/checkbox/index']
</script>
