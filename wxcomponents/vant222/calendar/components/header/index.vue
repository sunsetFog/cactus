<template>
<uni-shadow-root class="vant222-calendar-components-header-index"><view class="van-calendar__header">
...
global['__wxRoute'] = 'vant222/calendar/components/header/index'
...
export default global['__wxComponents']['vant222/calendar/components/header/index']
</script>
