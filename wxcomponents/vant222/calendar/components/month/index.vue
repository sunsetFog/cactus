<template>
<uni-shadow-root class="vant222-calendar-components-month-index"><view class="van-calendar__month" :style="computed.getMonthStyle(visible, date, rowHeight)">
...
global['__wxRoute'] = 'vant222/calendar/components/month/index'
...
export default global['__wxComponents']['vant222/calendar/components/month/index']
</script>
