<template>
<uni-shadow-root class="vant222-calendar-calendar"><view class="van-calendar">
...
global['__wxRoute'] = 'vant222/calendar/calendar'

Component({})

export default global['__wxComponents']['vant222/calendar/calendar']
</script>
