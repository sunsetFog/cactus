<template>
<uni-shadow-root class="vant222-cell-group-index"><view v-if="title" :class="utils.bem('cell-group__title', { inset })">
  {{ title }}
</view>
...
global['__wxRoute'] = 'vant222/cell-group/index'
...
export default global['__wxComponents']['vant222/cell-group/index']
</script>
