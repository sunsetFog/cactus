<template>
<uni-shadow-root class="vant222-dropdown-item-index"><view v-if="showWrapper" :class="utils.bem('dropdown-item', direction)" :style="wrapperStyle">
...
global['__wxRoute'] = 'vant222/dropdown-item/index'
...
export default global['__wxComponents']['vant222/dropdown-item/index']
</script>
