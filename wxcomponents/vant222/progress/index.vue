<template>
<uni-shadow-root class="vant222-progress-index"><view class="van-progress custom-class" :style="computed.rootStyle({ strokeWidth, trackColor })">
...
global['__wxRoute'] = 'vant222/progress/index'
...
export default global['__wxComponents']['vant222/progress/index']
</script>
