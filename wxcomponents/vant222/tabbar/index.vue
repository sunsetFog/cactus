<template>
<uni-shadow-root class="vant222-tabbar-index"><view :class="(border ? 'van-hairline--top-bottom' : '')+' '+(utils.bem('tabbar', { fixed, safe: safeAreaInsetBottom }))+' custom-class'" :style="zIndex ? 'z-index: ' + zIndex : ''">
  <slot></slot>
</view>
...
global['__wxRoute'] = 'vant222/tabbar/index'
...
export default global['__wxComponents']['vant222/tabbar/index']
</script>
