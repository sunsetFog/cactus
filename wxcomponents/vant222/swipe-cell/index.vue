<template>
<uni-shadow-root class="vant222-swipe-cell-index"><view class="van-swipe-cell custom-class" data-key="cell" @click.stop.prevent="onClick" @touchstart="startDrag" @touchmove.stop.prevent="_$self[(catchMove ? 'noop' : '')||'_$noop']($event)" @touchmove.capture="onDrag" @touchend="endDrag" @touchcancel="endDrag">
...
global['__wxRoute'] = 'vant222/swipe-cell/index'
...
export default global['__wxComponents']['vant222/swipe-cell/index']
</script>
