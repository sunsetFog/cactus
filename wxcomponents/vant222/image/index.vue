<template>
<uni-shadow-root class="vant222-image-index"><view :style="computed.rootStyle({ width, height, radius })" :class="'custom-class '+(utils.bem('image', { round }))" @click="onClick">
...
global['__wxRoute'] = 'vant222/image/index'
...
export default global['__wxComponents']['vant222/image/index']
</script>
