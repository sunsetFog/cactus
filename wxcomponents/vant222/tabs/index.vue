<template>
<uni-shadow-root class="vant222-tabs-index"><view :class="'custom-class '+(utils.bem('tabs', [type]))">
...
global['__wxRoute'] = 'vant222/tabs/index'
...
export default global['__wxComponents']['vant222/tabs/index']
</script>
