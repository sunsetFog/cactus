<template>
<uni-shadow-root class="vant222-transition-index"><view v-if="inited" :class="'van-transition custom-class '+(classes)" :style="computed.rootStyle({ currentDuration, display, customStyle })" @transitionend="onTransitionEnd">
  <slot></slot>
...
global['__wxRoute'] = 'vant222/transition/index'
...
export default global['__wxComponents']['vant222/transition/index']
</script>
