<template>
<uni-shadow-root class="vant222-collapse-item-index"><view :class="'van-collapse-item custom-class '+(index !== 0 ? 'van-hairline--top' : '')">
...
global['__wxRoute'] = 'vant222/collapse-item/index'
...
export default global['__wxComponents']['vant222/collapse-item/index']
</script>
