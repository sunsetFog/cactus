<template>
<uni-shadow-root class="vant222-dropdown-menu-index"><view class="van-dropdown-menu van-dropdown-menu--top-bottom custom-class">
...
global['__wxRoute'] = 'vant222/dropdown-menu/index'
...
export default global['__wxComponents']['vant222/dropdown-menu/index']
</script>
