<template>
<uni-shadow-root class="vant222-slider-index"><view :class="'custom-class '+(utils.bem('slider', { disabled, vertical }))" :style="wrapperStyle" @click="onClick">
...
global['__wxRoute'] = 'vant222/slider/index'
...
export default global['__wxComponents']['vant222/slider/index']
</script>
