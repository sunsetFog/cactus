<template>
<uni-shadow-root class="vant222-notice-bar-index"><view v-if="show" :class="'custom-class '+(utils.bem('notice-bar', { withicon: mode, wrapable }))" :style="computed.rootStyle({ color, backgroundColor, background })" @click="onClick">
...
global['__wxRoute'] = 'vant222/notice-bar/index'
...
export default global['__wxComponents']['vant222/notice-bar/index']
</script>
