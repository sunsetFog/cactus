<template>
<uni-shadow-root class="vant222-picker-index"><view class="van-picker custom-class">
...
global['__wxRoute'] = 'vant222/picker/index'
...
export default global['__wxComponents']['vant222/picker/index']
</script>
