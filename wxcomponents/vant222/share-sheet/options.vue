<template>
<uni-shadow-root class="vant222-share-sheet-options"><view :class="utils.bem('share-sheet__options', { border: showBorder })">
...
global['__wxRoute'] = 'vant222/share-sheet/options'
...
export default global['__wxComponents']['vant222/share-sheet/options']
</script>
