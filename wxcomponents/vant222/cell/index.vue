<template>
<uni-shadow-root class="vant222-cell-index"><view :class="'custom-class '+(utils.bem('cell', [size, { center, required, borderless: !border, clickable: isLink || clickable }]))" hover-class="van-cell--hover hover-class" hover-stay-time="70" :style="customStyle" @click="onClick">
...
global['__wxRoute'] = 'vant222/cell/index'
...
export default global['__wxComponents']['vant222/cell/index']
</script>
