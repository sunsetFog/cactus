<template>
<uni-shadow-root class="vant222-stepper-index"><view :class="(utils.bem('stepper', [theme]))+' custom-class'">
...
global['__wxRoute'] = 'vant222/stepper/index'
...
export default global['__wxComponents']['vant222/stepper/index']
</script>
