<template>
<uni-shadow-root class="vant222-panel-index"><view class="van-panel van-hairline--top-bottom custom-class">
...
global['__wxRoute'] = 'vant222/panel/index'
...
export default global['__wxComponents']['vant222/panel/index']
</script>
