<template>
<uni-shadow-root class="vant222-toast-index"><van-overlay v-if="mask || forbidClick" :show="show" :z-index="zIndex" :custom-style="mask ? '' : 'background-color: transparent;'"></van-overlay>
...
global['__wxRoute'] = 'vant222/toast/index'
...
export default global['__wxComponents']['vant222/toast/index']
</script>
