<template>
<uni-shadow-root class="vant222-circle-index"><view class="van-circle">
...
global['__wxRoute'] = 'vant222/circle/index'
...
export default global['__wxComponents']['vant222/circle/index']
</script>
