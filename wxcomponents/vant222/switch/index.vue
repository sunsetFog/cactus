<template>
<uni-shadow-root class="vant222-switch-index"><view :class="(utils.bem('switch', { on: checked === activeValue, disabled }))+' custom-class'" :style="computed.rootStyle({ size, checked, activeColor, inactiveColor, activeValue })" @click="onClick">
...
global['__wxRoute'] = 'vant222/switch/index'
...
export default global['__wxComponents']['vant222/switch/index']
</script>
