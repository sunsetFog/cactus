<template>
<uni-shadow-root class="vant222-steps-index"><view :class="'custom-class '+(utils.bem('steps', [direction]))">
...
global['__wxRoute'] = 'vant222/steps/index'
...
export default global['__wxComponents']['vant222/steps/index']
</script>
