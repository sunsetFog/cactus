<template>
<uni-shadow-root class="vant222-goods-action-index"><view :class="'custom-class '+(utils.bem('goods-action', { safe: safeAreaInsetBottom }))">
  <slot></slot>
...
global['__wxRoute'] = 'vant222/goods-action/index'
...
export default global['__wxComponents']['vant222/goods-action/index']
</script>
